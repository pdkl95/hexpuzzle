...
#define LEVEL_MIN_MINIMUM_PATH_DENSITY 1.0f
#define LEVEL_MAX_MINIMUM_PATH_DENSITY 4.0f
...
#define BROWSER_LEVEL_PREVIEW_SIZE DEFAULT_LEVEL_PREVIEW_SIZE
#define COLLECTION_LEVEL_PREVIEW_SIZE 125

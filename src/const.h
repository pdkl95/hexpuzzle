...
#define TILE_BASE_DENSITY 8
#define TILE_PATH_DENDITY 1
#define TILE_RESTITUTION 0.15f
#define TILE_STATIC_FRICTION 0.8
#define TILE_DYNAMIC_FRICTION 0.77
...
#define SOLVER_SOLVE_SWAP_TIME 0.5
#define SOLVER_UNDO_SWAP_TIME  0.3

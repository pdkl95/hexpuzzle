...
#define LEVEL_MIN_MINIMUM_PATH_DENSITY 100
#define LEVEL_MAX_MINIMUM_PATH_DENSITY 508
#define LEVEL_MIN_MINIMUM_PATH_DENSITY_FLOAT (float_div_100(LEVEL_MIN_MINIMUM_PATH_DENSITY))
#define LEVEL_MAX_MINIMUM_PATH_DENSITY_FLOAT (float_div_100(LEVEL_MAX_MINIMUM_PATH_DENSITY))
...
#define BUTTON_SELECTED_HIGHLIGHT_THICKNESS 3.0f
